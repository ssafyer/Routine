            ...
            <div className="board__body">
                ...
                <Swiper
                    ...
                    onSlideChange={(swiper) => {
                        setCategoryChoice(swiper.activeIndex)
                    }}
                >
                    <SwiperSlide>
                        ...
                        <div className="formbox retrospect">
                            ...
                            <Swiper
                                className="swiper__board__routine"
                                spaceBetween={50}
                                pagination={{
                                el: ".processbtmbox.box1",
                                clickable: true,
                                }}
                                modules={[Pagination]}
                            >
                            ...
                            <div className="processbtmbox box1">
                    ...
                    <div className="formbox actionType summary">
                        ...
                        <div className="formbox retrospect">
                            ...
                            <div className="processbtmbox box2">
                                <span className='active'></span>
                                <span></span>
                                <span></span>
                                <span></span>
